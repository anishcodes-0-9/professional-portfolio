...
export const personalInfo = {
  ...
  summary:
    "Full Stack Developer with 4+ years building scalable distributed systems for 10M+ users. I specialize in Full Stack Development. Currently freelancing at Alignerr evaluating Claude.",
};
...
export const personalProjects = [
  {
    ...
    description:
      "A Three.js powered interactive portfolio room with AI assistant, mini games, and dynamic environment. Clickable objects reveal different sections of the portfolio.",
  ...
  },
  {
    ...
    description:
      "A distributed task queue built with Java Spring Boot and Redis, supporting priority queues, retry logic, and dead-letter queues for resilient background processing.",
